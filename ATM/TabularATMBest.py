...
#---------------------------------------
# TabularATM.py
# (c) Jansen A. Simanullang, 03.08.2016
# 03.08.2016
#---------------------------------------
# usage: python TabularATM.py
#---------------------------------------
...
def putDataXL(offRow, offCol, TProblem, TUtility, TAvailability):
	...
	def makeHeader(xRow, yCol, jenisTabel):
		...
		arrJudul = ["CODE", "BRANCH", "NOP", "RSK", "OPS", "OOS", "OFF", "PRO"]
	...
	sheet1.col(offCol+shiftLeft+6).width = 4*315
	...
	book.save(RegionName + "-ATM PRO-" +time.strftime("%Y%m%d-%H")+'.xls')
